...
<div class="mb-3">
  ...
  <input type="text"
    class="form-control" name="categoría" id="categoría" aria-describedby="helpId" placeholder="categoría">
</div>

<div class="mb-3">
  <label for="url" class="form-label">URL</label>
  <input type="text"
    class="form-control" name="url" id="url" aria-describedby="helpId" placeholder="URL del la noticia">
</div>
