...
// 1) Guards / permisos por política
require_once __DIR__ . '/../../auth_guard.php';
require_permission('portafolio', 'edit');   // tanto admin como user pueden editar
...
<script>
// Tooltips + confirmación con SweetAlert
(function(){
